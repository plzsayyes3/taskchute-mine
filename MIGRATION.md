...
3. Replace the old `taskchute-mine` implementation with the TypeScript source corresponding to the production TaskLiner bundle.
4. Copy the production `styles.css`.
5. Build and verify that the generated plugin behaves like the production copy.
